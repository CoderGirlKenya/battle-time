...
export function Index() {
    ...
    button?addEventListener(click, function const handleButtonClick = (event : React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
...
{/* Added div to separate image and text */}
            ...
            <button onClick={handleButtonClick}> Let's get ready</button>
