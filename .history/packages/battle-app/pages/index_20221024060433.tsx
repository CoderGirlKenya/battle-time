...
export function Index() {
    ...
    useEffect(()=>{
        ...
        (async ()=>{
            ...
            const questions =await Promise.resolve<questions>
                
            // const questions:Que  stion[]=await response.json();
            // if(!m){return;}
...
{/* Added div to separate image and text */}
            ...
            <button id={"btn"} onClick={handleButtonClick}> Let's get ready</button>
